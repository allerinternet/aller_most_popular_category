...
<div <?php print 'style="border-bottom: ' . get_option('aller_separator_width') . 'px ' . get_option('aller_separator_type') . ' ' . get_option('aller_color_separator'); ?>>
  <?php if (isset($title)) : ?>
